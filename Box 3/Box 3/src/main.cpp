...
void loop()
{
  ...
  if (currentMillis - lastUpdate >= updateInterval)
  {
    ...
    ambientTemperature = ambientSensor.temperature(RNOMINAL, RREF) * 1.8 + 32 - 2.8;
    temp1 = sensor1.temperature(RNOMINAL, RREF) * 1.8 + 32 + 6.0;
    temp2 = sensor2.temperature(RNOMINAL, RREF) * 1.8 + 32 + 9.0;
    temp3 = sensor3.temperature(RNOMINAL, RREF) * 1.8 + 32 + 3.0;
    temp4 = sensor4.temperature(RNOMINAL, RREF) * 1.8 + 32 + 11.0;
