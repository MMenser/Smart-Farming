...
Adafruit_MAX31865 sensor2 = Adafruit_MAX31865(9, 11, 12, 13); // CS pin 10 -- CS pins are what allows Arduino board to identify seperate devices 
Adafruit_MAX31865 sensor3 = Adafruit_MAX31865(8, 11, 12, 13); // CS pin 10 -- CS pins are what allows Arduino board to identify seperate devices 
Adafruit_MAX31865 sensor4 = Adafruit_MAX31865(7, 11, 12, 13); // CS pin 10 -- CS pins are what allows Arduino board to identify seperate devices 
Adafruit_MAX31865 sensor5 = Adafruit_MAX31865(6, 11, 12, 13); // CS pin 10 -- CS pins are what allows Arduino board to identify seperate devices 
...
void setup() {
  ...
  sensor2.begin(MAX31865_3WIRE);  // set to 2WIRE or 4WIRE as necessary
  sensor3.begin(MAX31865_3WIRE);  // set to 2WIRE or 4WIRE as necessary
  sensor4.begin(MAX31865_3WIRE);  // set to 2WIRE or 4WIRE as necessary
  sensor5.begin(MAX31865_3WIRE);  // set to 2WIRE or 4WIRE as necessary
}
